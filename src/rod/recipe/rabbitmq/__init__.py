...
#!/bin/sh
# DO NOT EDIT! This script is generated by rod.recipe.rabbitmq.

# Mimic the standard rabbitmq-env script.
...
# Mimic the standard rabbitmq-defaults script.
...
PLUGINS_DIR="%(part)s/plugins"

# Add some other overrides
SERVER_START_ARGS="%(cookie_option)s"
CTL_ERL_ARGS="%(cookie_option)s"
PID_FILE=%(pidfile)s
%(erlang_path)s

CONF_ENV_FILE="%(buildout)s/etc/rabbitmq-env.conf"
